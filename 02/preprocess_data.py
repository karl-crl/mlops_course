...
def run(raw_data_path: str, dest_path: str, dataset: str = "green"):
    ...
    dump_pickle(dv, os.path.join(dest_path, "output/dv.pkl"))
    dump_pickle((X_train, y_train), os.path.join(dest_path, "output/train.pkl"))
    dump_pickle((X_valid, y_valid), os.path.join(dest_path, "output/valid.pkl"))
    dump_pickle((X_test, y_test), os.path.join(dest_path, "output/test.pkl"))
